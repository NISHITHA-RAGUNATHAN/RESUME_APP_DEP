    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="author" content="Nishitha R" />
            ...
            <Box
                bg="#DCDCDC"  // Light gray background color
                minH="100vh"  // Ensure it covers the full screen height
                display="flex"
            ...
            >
                ...
                <Container 
                    ...
                    display={'flex'} 
                    alignItems={'center'}
                    maxW={'full'}   // Make container full width
...

                        {
                            ...
                            ?
                                <>
                                    ...
                                    <Text color={'white.500'} maxW={'3xl'} textColor={'purple'} className='inthead'>
